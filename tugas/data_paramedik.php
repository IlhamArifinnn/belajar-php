                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($query as $row) {
                                            ...
                                            echo "<td>
                                            <a href='#' onclick='return confirmDelete(" . $row['id'] . ")' class='btn btn-danger btn-sm mr-2'>Delete</a>";
                                            echo "<a href='update_paramedik.php?id=" . $row['id'] . "' class='btn btn-success btn-sm' >Update</a></td>";
                                            echo "</tr>";
                                        }
                                        ?>
                                    </tbody>
